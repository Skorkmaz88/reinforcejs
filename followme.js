...
World.prototype = {
  ...
  tick: function() {
    ...
    for(var i=0,n=this.items.length;i<n;i++) {
      ...
      for(var j=0,m=this.agents.length - 1;j<m;j++) {
        var a = this.agents[j];
    ...
    // Item adder
    if(this.items.length < 200 && this.clock % 5 === 0 ) {
      ...
      var newitt2 = 2 // Always food randi(1, 3); // food or poison (1 and 2)
      var newit2 = new Item(newitx2, newity2, newitt2);

      var newitx3 = this.agents[1].p.x + 50;
      var newity3 = this.agents[1].p.y + 50;
      var newitt3 = 2 // Always food randi(1, 3); // food or poison (1 and 2)
